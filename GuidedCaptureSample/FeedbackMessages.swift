    ...
    static func getFeedbackString(for feedback: ObjectCaptureSession.Feedback, captureMode: AppDataModel.CaptureMode) -> String? {
           switch feedback {
               case .objectTooFar:
                   ...
                   if captureMode == .rotation {
                       return NSLocalizedString(
                        "Move Object Closer (Object Capture)",
                        bundle: Bundle.main,
                        value: "Move Object Closer",
                        comment: "Feedback message to move object closer for rotation capture")
                   }
                   return NSLocalizedString(
               ...
               case .objectTooClose:
                   ...
                   if captureMode == .rotation {
                       return NSLocalizedString(
                        "Move Object Farther Away (Object Capture)",
                        bundle: Bundle.main,
                        value: "Move Object Farther Away",
                        comment: "Feedback message to move object back for rotation capture")
                   }
                   return NSLocalizedString(
               ...
               case .movingTooFast:
                   if captureMode == .rotation {
                       return NSLocalizedString(
                        "Rotate slower (Object Capture)",
                        bundle: Bundle.main,
                        value: "Rotate slower",
                        comment: "Feedback message to rotate object slower for object capture")
                   } else {
                       return NSLocalizedString(
