    ...
    var body: some View {
        Button(action: {
            ...
            showOnboardingView = true
               ...
               label: {
            Text((appModel.captureMode == .object || appModel.captureMode == .rotation) ? LocalizedString.next : LocalizedString.done)
                .modifier(VisualEffectRoundedCorner())
        })
...
private struct CaptureModeGuidanceView: View {
    ...
    private var guidanceText: String {
        switch appModel.captureMode {
            ...
            case .rotation:
                return LocalizedString.rotationMode
        }
    }
    ...
    private struct LocalizedString {
        ...
        static let rotationMode = NSLocalizedString(
            "Rotation mode (Object Capture)",
            bundle: Bundle.main,
            value: "ROTATION MODE",
            comment: "Title for the Rotation Mode guidance text.")
    }
}
